...
export function buildPlanBundle(S, name) {
  ...
  return { fittrix_plan: PLAN_FMT, opengym_plan: PLAN_FMT, exported: todayISO(), name: name || '', week, routines, customEx }
}
...
export function parsePlan(raw) {
  ...
  if (!data || (!data.fittrix_plan && !data.opengym_plan) || !Array.isArray(data.routines)) {
